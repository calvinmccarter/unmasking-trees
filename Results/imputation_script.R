...
data = read.csv("Results_tabular - imputation.csv")
data = read.csv("Results_tabular - imputation.csv")
...
methods = c('KNN(n_neighbors=1)', 'ice', 'miceforest', 'MissForest', 'softimpute', 'OT', 'GAIN', 'forest_diffusion_repaint_nt51_ycond', 'utrees')
methods_all = c('KNN(n_neighbors=1)', 'ice', 'miceforest', 'MissForest', 'softimpute', 'OT', 'GAIN', 'forest_diffusion_repaint_nt51_ycond', 'utrees', 'oracle')
...
rownames(data_summary_t) = c("KNN", "ICE", "MICE-Forest", "MissForest", "Softimpute", "OT", "GAIN", "Forest-VP", "utrees", "Oracle")
rownames(data_summary_rank_t) = c("KNN", "ICE", "MICE-Forest", "MissForest", "Softimpute", "OT", "GAIN", "Forest-VP", "utrees")
