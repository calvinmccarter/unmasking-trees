...
methods_all = c('GaussianCopula', 'TVAE', 'CTGAN', 'CTABGAN', 'stasy', 'TabDDPM', 'forest_diffusion_vp_nt51_ycond', 'forest_diffusion_flow_nt51_ycond', 'oracle', 'utrees')

# Change the folder to your own
data = read.csv("Results_tabular - generation_miss.csv")
...
rownames(data_summary_t) = c("GaussianCopula", "TVAE", "CTGAN", "CTABGAN", "Stasy", "TabDDPM", "Forest-VP", "Forest-Flow", "Utrees", "Oracle")
rownames(data_summary_rank_t) = c("GaussianCopula", "TVAE", "CTGAN", "CTABGAN", "Stasy", "TabDDPM", "Forest-VP", "Forest-Flow", "UTrees")
